...
public enum AysErrorMessage {
    ...
    ADMIN_REGISTRATION_APPLICATION_ALREADY_APPROVED("admin registration application was already approved or rejected!"),
    ADMIN_REGISTRATION_APPLICATION_ALREADY_REJECTED("admin registration application was already rejected!"),
    ADMIN_REGISTRATION_APPLICATION_IS_NOT_COMPLETED("admin registration application is not complete!"),
