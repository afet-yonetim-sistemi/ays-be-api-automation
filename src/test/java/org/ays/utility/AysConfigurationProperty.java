...
public class AysConfigurationProperty {
    ...
    public static class SuperAdminUserOne {
        public static final String EMAIL_ADDRESS = PROPERTIES.getProperty("institution.super_admin_user_one.email");
    ...
    public static class InstitutionOne {
        ...
        public static class AdminUserOne {
            public static final String EMAIL_ADDRESS = PROPERTIES.getProperty("institution_one.admin_user_one.email");
